<div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <strong>{!! Form::text('valor', null, ['onkeypress' => 'return soloNumeros(event)', 'class' => 'form-control'] ) !!}</strong>
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 form-group">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
            @if($errors->all('sesiones'))
                <div class="" role="alert">
                    <strong><p class="porte2 pull-right">{{ $errors->first('sesiones') }}</p></strong>
                </div>
            @endif
        </div>

        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <strong>{!!Form::number('sesiones', 1, ['onkeypress' => 'return soloNumeros(event)']) !!}</strong>
        </div>
    </div>
